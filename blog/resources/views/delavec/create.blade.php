...
<h1 style="margin-top: 20px; margin-bottom: 20px;">Dodajanje: Delavec</h1>
        
<a href="{{route('delavec.index')}}" class="btn btn-success" style="float: right">Nazaj</a>
<br><br>
...
<form method="POST" action="{{url('delavec')}}">
    @csrf
